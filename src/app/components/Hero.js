        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div class="lg:grid lg:grid-cols-2 lg:gap-x-8 lg:gap-y-20">
            <div class="text-center sm:text-left relative z-10 mx-auto max-w-2xl lg:max-w-none lg:pt-6 sm:col-span-1">
              <p class="text-base font-semibold leading-7 text-sky-500">
                Experience the difference today.
              </p>
              <h1 class="col-start-1 row-start-2 mt-4 max-w-[36rem] text-3xl font-extrabold tracking-tight text-slate-900 sm:text-7xl xl:max-w-[43.5rem]">
                Introducing{" "}
            ...
            <div class="relative flex my-14   gap-8 justify-center p-4 lg:pl-20 w-full h-full">
              <div class="absolute left-0 -right-12 -top-7 h-px bg-slate-900/[0.2] [mask-image:linear-gradient(to_right,transparent,white_4rem,white_calc(100%-4rem),transparent)]"></div>
              <div class="absolute -left-4 -right-2  -top-24 -skew-y-12 h-px bg-slate-900/[0.2] [mask-image:linear-gradient(to_right,transparent,white_4rem,white_calc(50%-14rem),transparent)]"></div>
              <div class="absolute -top-8 bottom-0 left-32 w-px bg-slate-900/[0.2] [mask-image:linear-gradient(to_top,transparent,white_4rem,white_calc(100%-4rem),transparent)]"></div>
              <div class="absolute right-16 -top-2 -bottom-2 w-px bg-slate-900/[0.2] [mask-image:linear-gradient(to_top,transparent,white_4rem,white_calc(100%-4rem),transparent)]"></div>
              <div class="absolute right-1 -top-2 skew-x-12 -bottom-2 w-px bg-slate-900/[0.2] [mask-image:linear-gradient(to_top,transparent,white_4rem,white_calc(100%-4rem),transparent)]"></div>
              <div class="absolute left-0 right-12 bottom-20 h-px bg-slate-900/[0.2] [mask-image:linear-gradient(to_right,transparent,white_4rem,white_calc(100%-4rem),transparent)]"></div>
              <div class="z-0 tube overflow-hidden "></div>
              <div class="z-0 tube overflow-hidden"></div>
              <div class="z-0 tube overflow-hidden"></div>
              <div class="z-0 tubeBlue overflow-hidden"></div>
            </div>
          </div>
          <SubscribeToNews />
        </div>
